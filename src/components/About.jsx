...
const About = () => {
  return (
    <section id="about" className="min-h-screen bg-slate-50 dark:bg-[#050505] text-zinc-900 dark:text-white font-black py-20 px-6 relative overflow-hidden transition-colors duration-700">
