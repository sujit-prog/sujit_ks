...
const Projects = () => {
  return (
    <div id="projects" className="min-h-screen bg-slate-50 dark:bg-[#050505] text-zinc-900 dark:text-white font-black p-6 md:p-12 relative overflow-hidden transition-colors duration-700">
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-end justify-between mb-16 border-b-4 border-white/10 pb-8">
          <div>
            ...
            <motion.h2
              ...
              className="text-5xl sm:text-6xl md:text-8xl font-black italic uppercase tracking-tighter leading-none text-wrap sm:text-nowrap break-all sm:break-normal"
            >
              PROJECT_LOGS
            </motion.h2>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          {PROJECTS.map((project, idx) => (
            <motion.div
              ...
              whileHover={{ y: -12 }}
              className="group relative bg-zinc-100 dark:bg-zinc-900 border-4 border-black shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] flex flex-col overflow-hidden h-full transition-colors"
            >
              {/* Image Preview */}
        ...
        >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="bg-white text-black border-4 border-black px-8 sm:px-12 py-4 sm:py-5 shadow-[6px_6px_0px_0px_rgba(255,0,0,1)] sm:shadow-[10px_10px_0px_0px_rgba(255,0,0,1)] flex items-center gap-4 group text-center"
          >
            <Github size={20} className="group-hover:rotate-12 transition-transform shrink-0" />
            <span className="text-[10px] sm:text-sm font-black uppercase tracking-[0.2em] sm:tracking-[0.3em]">Query_All_Repos</span>
          </motion.button>
        </motion.div>
      </div>
    </div>
