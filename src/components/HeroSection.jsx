          ...
          <motion.div exit={{ opacity: 0, scale: 1.1 }} className="fixed inset-0 z-[200] flex items-center justify-center bg-black/95 backdrop-blur-xl">
            <div className="flex flex-col items-center gap-8 sm:gap-12 px-6">
              <div className="text-center">
                <p className="text-red-600 text-[8px] sm:text-[10px] font-bold tracking-[0.4em] sm:tracking-[0.6em] mb-2 uppercase text-center">Ignition System Offline</p>
              ...
              >
                ...
                <div className="relative w-28 h-28 sm:w-40 sm:h-40 rounded-full bg-gradient-to-br from-red-600 to-red-900 border-4 border-black flex flex-col items-center justify-center group-hover:from-red-500 transition-all">
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="w-full min-h-screen flex flex-col items-center justify-center relative pt-20 pb-12">
            ...
            <AnimatePresence>
              {stampSequence === 'slamming' && (
                ...
                >
                  <div className="border-[8px] sm:border-[16px] border-red-600 bg-red-600/10 px-6 sm:px-12 py-3 sm:py-6 rotate-[-12deg] shadow-[0_0_100px_rgba(220,38,38,0.5)]">
                    <span className="text-red-600 text-3xl sm:text-8xl font-black italic uppercase tracking-tighter text-center">PILOT_VERIFIED</span>
                  </div>
                </motion.div>
              )}
            </AnimatePresence>
            ...
            <div className="container mx-auto px-6 relative z-10 w-full">
              <div className="flex flex-col items-center">
                ...
                >
                  ...
                  <h2 className={`text-[10vw] sm:text-[9vw] leading-none tracking-tighter ${textColor} mt-[-7vw] sm:mt-[-6vw] relative z-10 italic drop-shadow-2xl`}>SUJIT <span className={'text-red-600'}>KUMAR SHA</span></h2>
                  ...
                  <div className="flex flex-col items-center gap-4 sm:gap-8 mt-6 sm:mt-12">
                    <div className="flex items-center gap-8 sm:gap-16">
                      <div className="text-center">
                        ...
                        <p className={`text-4xl sm:text-6xl font-black italic tabular-nums text-red-500`}>{Math.round(score / 2 + 100)}</p>
                      </div>
                            ...
                            <motion.div animate={{ left: `${playerLane * 33.3}%` }} className="absolute bottom-6 sm:bottom-10 w-1/3 h-20 sm:h-24 flex items-center justify-center z-10">
                              <motion.div className="w-12 h-20 sm:w-14 sm:h-24 relative">
                                ...
                                <motion.div
                                  ...
                                  className="absolute -bottom-2 left-1/2 -translate-x-1/2 w-3 sm:w-4 h-6 sm:h-8 bg-gradient-to-t from-red-600 to-orange-400 blur-sm rounded-full"
                                />
                              </motion.div>
                            </motion.div>
                          </div>
                          ...
                          <div className="flex gap-4 mt-4 sm:mt-6 w-full justify-center">
                            {[0, 1, 2].map((lane) => (
                              <motion.button
                                ...
                                className={`w-12 h-12 sm:w-14 sm:h-14 border-4 border-black flex items-center justify-center transition-all ${playerLane === lane ? 'bg-red-600 text-white shadow-none translate-y-1' : 'bg-zinc-800 text-zinc-500 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]'}`}
                              >
                                {lane === 0 ? <ChevronLeft size={20} /> : lane === 2 ? <ChevronRight size={20} /> : <div className="w-2.5 h-2.5 rounded-full bg-current" />}
                              </motion.button>
                            ))}
                          </div>
                          <p className="text-[7px] sm:text-[9px] uppercase font-bold text-zinc-500 mt-2 sm:mt-3 tracking-widest text-center w-full">Select Lane</p>
                        </div>
                      )}
                      {gameState === 'crashed' && (
                        <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }} className="absolute -top-8 sm:-top-12 left-1/2 -translate-x-1/2 bg-red-600 text-white px-4 sm:px-6 py-1.5 sm:py-2 text-xs sm:text-[14px] italic font-black shadow-2xl border-2 border-white skew-x-[-12deg] z-[100] whitespace-nowrap">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 sm:gap-4 w-full max-w-5xl relative z-50 px-2 sm:px-4 mt-4 sm:mt-12 pb-12">
                  ...
                  <DashCard href="#about" title="PILOT" subtitle="Profile" color="bg-emerald-500" icon={<User size={20} />} />
                  <DashCard href="#experience" title="TRACK" subtitle="History" color="bg-purple-600" icon={<Briefcase size={20} />} />
                  <DashCard href="#contact" title="COMMS" subtitle="Connect" color="bg-red-600" icon={<Mail size={20} />} />
      ...
      >
        ...
        <div className={`absolute inset-0 backface-hidden ${isDark ? 'bg-zinc-900 border-white/20 text-white' : 'bg-white border-black/10 text-black'} border-4 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] p-3 sm:p-6 font-mono flex flex-col`}>
          <div className="flex justify-between items-center border-b-2 border-zinc-800 pb-1.5 sm:pb-3 mb-2 sm:mb-4">
            <p className="text-[8px] sm:text-[11px] font-black uppercase text-red-600 italic tracking-[0.2em]">PILOT_AUTH_v3.2</p>
          ...
          <div className="flex gap-3 sm:gap-6 text-left flex-1">
            ...
            <div className="flex-1 flex flex-col justify-between py-0.5 sm:py-1">
              <div className="space-y-0.5 sm:space-y-1">
                <p className="text-[6px] sm:text-[7px] text-zinc-500 uppercase tracking-widest leading-none text-left">ID_PILOT_VERIFIED</p>
              ...
              <div className="mt-1 sm:mt-4 space-y-1 sm:space-y-2">
                ...
                <motion.a
                  ...
                  whileHover={{ scale: 1.05 }}
                  className="flex items-center justify-between bg-red-600 text-white px-2 sm:px-3 py-1 sm:py-2 text-[7px] sm:text-[9px] font-black uppercase italic tracking-tighter border border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] sm:shadow-[3px_3px_0px_0px_rgba(0,0,0,1)]"
                >
        ...
        {/* Back */}
        <div className={`absolute inset-0 backface-hidden rotate-y-180 ${isDark ? 'bg-zinc-950 border-red-600 text-white' : 'bg-slate-100 border-blue-600 text-black'} border-4 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] p-3 sm:p-6 flex flex-col justify-between`}>
          ...
          <div className="flex flex-col gap-2 sm:gap-3 py-2 sm:py-4">
            <a href="#projects" className="bg-zinc-900 border border-zinc-800 p-2 sm:p-3 text-[9px] sm:text-[11px] font-black italic text-center text-white hover:border-red-500 transition-colors uppercase">Garage_Logs</a>
            <a href="#experience" className="bg-zinc-900 border border-zinc-800 p-2 sm:p-3 text-[9px] sm:text-[11px] font-black italic text-center text-white hover:border-red-500 transition-colors uppercase">Work_Hist</a>
            <a href="#contact" className="bg-zinc-900 border border-zinc-800 p-2 sm:p-3 text-[9px] sm:text-[11px] font-black italic text-center text-white hover:border-red-500 transition-colors uppercase">Comms_Feed</a>
          </div>
